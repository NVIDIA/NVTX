 ...
 *
 * Ordering is: regular @ref nvtxEventAttributes_t attributes first, then
 * @ref nvtxPayloadData_t entries in array order, then schema entries in order.
 *
 ...
 *       \c nvtxCounterAttr_t::scopeId; see \ref nvtxCounterRegister).
 * </ol>
 *
 ...
 * attached to @ref nvtxEventAttributes_t via its `payload.ullValue`
