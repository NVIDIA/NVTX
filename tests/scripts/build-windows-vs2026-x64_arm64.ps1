...
cmd /c "vcvarsall.bat x64_arm64 -vcvars_ver=14.50 & set" |
foreach {
  if ($_ -match "=") {
...
$NAME = "build-windows-vs2026-x64_arm64"
New-Item -ItemType Directory -Force -Path $NAME | Out-Null
Set-Location $NAME

$FLAGS = "-Wall -wd4191 -wd4255 -wd4355 -wd4365 -wd4514 -wd4668 -wd4710 -wd4711 -wd4746 -wd4820 -wd4865 -wd5039 -wd5045 -wd5220 -WX -Zc:preprocessor"
