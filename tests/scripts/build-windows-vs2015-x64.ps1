...
cmd /c "vcvarsall.bat x64 10.0.22621.0 -vcvars_ver=14.0 & set" |
foreach {
  if ($_ -match "=") {
...
$NAME = "build-windows-vs2015-x64"
New-Item -ItemType Directory -Force -Path $NAME | Out-Null
Set-Location $NAME

$FLAGS = "-Wall -wd4013 -wd4191 -wd4255 -wd4355 -wd4365 -wd4514 -wd4571 -wd4623 -wd4625 -wd4626 -wd4628 -wd4668 -wd4710 -wd4711 -wd4774 -wd4820 -wd5026 -wd5027 -wd5039 -wd5045 -wd5220 -WX"
